...
urlpatterns = [
    ...
    path(
        "contacts/<int:pk>/",
        views.AdminContactMessageDetailView.as_view(),
        name="contact_detail",
    ),
    path(
        "contacts/<int:pk>/delete/",
        views.AdminContactMessageDeleteView.as_view(),
        name="contact_delete",
    ),
    # Email Subscribers
    path(
        "email-subscribers/",
        views.AdminEmailSubscribersListView.as_view(),
        name="email_subscribers",
    ),
    path(
        "email-subscribers/export-csv/",
        views.AdminEmailSubscribersExportCSVView.as_view(),
        name="email_subscribers_export_csv",
    ),
    path(
        "email-subscribers/add/",
        views.AdminEmailSubscribersCreateView.as_view(),
        name="email_subscriber_add",
    ),
    path(
        "email-subscribers/<int:pk>/update",
        views.AdminEmailSubscriberEdit.as_view(),
        name="email_subscriber_edit",
    ),
    path(
        "email-subscribers/<int:pk>/delete/",
        views.AdminEmailSubscriberDeleteView.as_view(),
    ...
    path(
        ...
        views.AdminPartnerUpdateView.as_view(),
        name="partner_edit",
    ),
    path(
        "partners/<int:pk>/delete/",
        views.AdminPartnerDeleteView.as_view(),
        name="partner_delete",
    ),
    # Testimonials
    path(
    ...
    path(
        "testimonials/add/",
        views.AdminTestimonialCreateView.as_view(),
        name="testimonial_add",
    ),
    path(
        "testimonials/<int:pk>/edit/",
        views.AdminTestimonialUpdateView.as_view(),
        name="testimonial_edit",
    ),
    path(
        "testimonials/<int:pk>/delete/",
        views.AdminTestimonialDeleteView.as_view(),
