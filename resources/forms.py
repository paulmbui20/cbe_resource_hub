...
class ResourceItemForm(forms.ModelForm):
    class Meta:
        ...
        fields = [
            ...
            'grade', 'learning_area', 'academic_session',
            'file', 'is_free', # 'price'
        ]
        widgets = {
            ...
            'academic_session': forms.Select(attrs={'class': 'w-full rounded-lg bg-black/50 border border-white/10 px-3 py-2 text-sm text-white focus:ring-2 focus:ring-brand-primary'}),
